...
export const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  },
  {
    ...
    answer:
      "O projeto reúne etapas, entregas versionadas, diário com fotos, custos, horas da equipe, cobranças e andamento público. Use cada seção para manter execução, decisões do cliente e margem no mesmo lugar.",
    keywords: [
      "etapas",
      "entregas",
      "versão",
  ...
  },
  {
    id: "publicar-entrega",
    category: "projects",
    question: "Como envio uma entrega para o cliente aprovar?",
    answer:
      "Abra o projeto ou a obra e vá em Entregas. Crie um rascunho com PDF, imagem ou link HTTPS, confira o material e publique a versão. Depois copie o portal ou abra o WhatsApp com a mensagem pronta.",
    steps: [
      "Abra Entregas dentro do projeto ou da obra.",
      "Adicione o arquivo ou link e crie o rascunho.",
      "Abra o material para conferir e publique a versão.",
      "Envie o portal ao cliente para ele aprovar ou pedir ajustes.",
    ],
    keywords: [
      "entrega",
      "arquivo",
  ...
  },
  {
    ...
    answer:
      "O pedido fica registrado na versão revisada e aparece nas Pendências. Faça o ajuste, use Criar nova versão, envie o novo material e publique. A versão anterior e a decisão do cliente permanecem no histórico.",
    keywords: [
      "ajuste",
      "alteração",
      "nova versão",
    ...
    action: { label: "Abrir pendências", href: "/app/pendencias" },
  },
  {
