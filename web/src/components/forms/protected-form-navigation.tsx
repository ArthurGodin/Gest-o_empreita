...
interface ProtectedFormNavigationProps {
  dirty: boolean;
  contentLabel?: string;
...
export function ProtectedFormNavigation({
  ...
  const nativeConfirmMessage =
    confirmMessage ??
    `Existem alterações não salvas ${contentLabel}. Deseja sair sem salvar?`;
  ...
  useEffect(() => {
    ...
    function onPopState() {
      ...
      if (window.confirm(nativeConfirmMessage)) {
    ...
    >
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Se você sair agora, as mudanças feitas {contentLabel} serão
            perdidas.
          </DialogDescription>
        </DialogHeader>
